...
public class IdGeneratorApi {
    ...
    public ResponseResult get(@RequestParam Map<String, Object> params) {
        ...
        String bizType = String.valueOf(params.get("bizType"));
        try {
    ...
    public ResponseResult getBizNo(@RequestParam Map<String, Object> params) {
        ...
        try {
            ...
            if (id != null) {
                ...
                String bizNo = DateUtil.format(DateUtil.date(), DatePattern.PURE_DATE_PATTERN) + "" + id.getVersion() + "" + id.getCurrentId();
