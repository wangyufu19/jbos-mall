...
public class MaterialBuyApi {
    ...
    @GetMapping("/list")
    @ApiOperation("查询物采购业务列表")
    public ResponsePageResult getMaterialBuyList(@RequestParam Map<String, Object> params) {
    ...
    public ResponseResult infoById(@RequestParam Map<String, Object> params) {
        ResponseResult res = ResponseResult.ok();
        try {
            MaterialBuyDto materialBuyDto = materialBuyService.getMaterialBuyById(String.valueOf(params.get("id")));
